package org.py4j.connector.http;


import org.apache.catalina.util.RequestUtil;
import org.apache.catalina.util.StringManager;
import org.py4j.ServletProcessor;
import org.py4j.StaticResourceProcessor;
...
public class HttpProcessor {
  ...
  protected StringManager sm =
    StringManager.getManager("org.py4j.connector.http");
  ...
  public void process(Socket socket) {
    ...
    try {
      ...
      response.setHeader("Server", "Py4j Servlet Container");
